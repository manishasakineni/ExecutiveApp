...
class AgentPersonalResultVo: Mappable {
    ...
    init(AgentRequestId:Int?,AgentId:String?,AspNetUserId:String?,TitleTypeId:Int?,FirstName:String?,MiddleName:String?,LastName:String?,Phone:String?,Email:String?,GenderTypeId:Int?,DOB:String?,Address1:String?,Address2:String?,Landmark:String?,VillageId:Int?,ParentAspNetUserId:String?,EducationTypeId:Int?,Id:Int?,IsActive:Bool?,CreatedBy:String?,ModifiedBy:String?,Created:String?,Modified:String?) {
