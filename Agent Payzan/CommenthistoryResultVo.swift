...
class CommenthistoryResultVo: Mappable {
    
    // MARK: - Diclaration of Comment history Result Objects
    ...
    // MARK: - Intialzation of Comment history Result Objects
